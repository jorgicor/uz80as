...
const struct matchtab s_matchtab_i8085[] = {
	{ "MOV M,i", "70c0." },
	{ "MOV i,M", "46b0." },
	{ "MOV i,i", "40b0c1." },
	{ "MVI b,a", "06b0.d1." },
	...
	{ "RIM", "20." },
	{ "SIM", "30." },
	{ "ARHL", "10.", MATCH_F_UNDOC },
	{ "DSUB", "08.", MATCH_F_UNDOC },
	{ "RDEL", "18.", MATCH_F_UNDOC },
	{ "LDHI a", "28.d0.", MATCH_F_UNDOC },
	{ "LDSI a", "38.d0.", MATCH_F_UNDOC },
	{ "RSTV", "CB.", MATCH_F_UNDOC },
	{ "SHLX", "D9.", MATCH_F_UNDOC },
	{ "LHLX", "ED.", MATCH_F_UNDOC },
	{ "JNK a", "DD.e0", MATCH_F_UNDOC },
	{ "JNX5 a", "DD.e0", MATCH_F_UNDOC },
	{ "JNUI a", "DD.e0", MATCH_F_UNDOC },
	{ "JK a", "FD.e0", MATCH_F_UNDOC },
	{ "JX5 a", "FD.e0", MATCH_F_UNDOC },
	{ "JUI a", "FD.e0", MATCH_F_UNDOC },
	{ NULL, NULL },
};
...
static int match_i8085(char c, const char *p, const char **q)
{
	int v;
...
static int gen_i8085(int *eb, char p, const int *vs, int i, int savepc)
{
	int b;
...
static void pat_char_rewind_i8085(int c)
{
	s_pat_char = c;
	s_pat_index = 0;
};

static const char *pat_next_str_i8085(void)
{
	const char *s;
