...
const struct matchtab s_matchtab_gbcpu[] = {
	...
	{ "LD b,a", "06b0.d1.", 1, 0, "8" },
	{ "LD SP,HL", "F9.", 1, 0 },
	{ "LDHL SP,a", "F8.d0.", 1, 0, "8" }, // * LD HL,SP+n
	{ "LD d,a", "01f0.e1", 1, 0 },
	...
	{ "LD (a),SP", "08.e0", 1, 0 }, // *
	{ "LDH A,(a)", "F0.d0.", 1, 0, "8" }, // * LD A,(FF00+n)
	{ "LDH (a),A", "E0.d0.", 1, 0, "8" }, // * LD (FF00+n),A
	{ "PUSH f", "C5f0.", 1, 0 },
	{ "POP f", "C1f0.", 1, 0 },
	{ "ADD HL,d", "09f0.", 1, 0 },
	{ "ADD SP,a", "E8.d0.", 1, 0, "8" }, // * 
	{ "g A,b", "m080b0c1.", 1, 0 },
	{ "g A,(HL)", "m086b0.", 1, 0 },
	{ "g A,a", "m0C6b0.d1.", 1, 0, "8" },
	{ "g b", "n080b0c1.", 1, 0 },
	{ "g (HL)", "n086b0.", 1, 0 },
	{ "g a", "n0C6b0.d1.", 1, 0, "8" },
	{ "h b", "04b1c0.", 1, 0 },
	...
	{ "o b", "CB.00b0c1.", 1, 0 },
	{ "o (HL)", "CB.06b0.", 1, 0 },
	{ "l a,b", "CB.00g0b1c2.", 1, 0, "b" },
	{ "l a,(HL)", "CB.06g0b1.", 1, 0, "b" },
	{ "JP (HL)", "E9.", 1, 0 },
	{ "JP n,a", "C2b0.e1", 1, 0 }, // *
	{ "JP a", "C3.e0", 1, 0 },
	{ "JR n,a", "20b0.i1.", 1, 0, "r" },
	{ "JR a", "18.i0.", 1, 0, "r" },
	{ "STOP", "10.00.", 1, 0 }, // *
